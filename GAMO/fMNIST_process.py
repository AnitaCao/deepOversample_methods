...
# load csv files with out the first row


trainDataOri = np.loadtxt('fashionMnist_train.csv', delimiter=',', skiprows=1)
testDataOri=np.loadtxt('fashionMnist_test.csv', delimiter= ',' , skiprows=1)
