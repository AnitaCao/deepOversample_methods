...
class DeepSMOTE_cifar10(Dataset):
...
def get_data_loader(trail_batch_size, val_batch_size):
  train_data = DeepSMOTE_cifar10(X_train, y_train, transform=transform)
  test_data = DeepSMOTE_cifar10(X_test, y_test, transform=transform)
